...
export default function Servicos() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Animação sequencial (stagger) dos cards de serviços
      if (cardsRef.current) {
        gsap.fromTo(
    ...
    // Reverter as animações e triggers ao desmontar
    return () => ctx.revert();
  }, []);

  // Dados dos serviços conforme especificado pelo usuário
  const servicosData = [
    {
      title: "Consultoria em Comércio Exterior",
      description: "Planejamento estratégico para importação e exportação.",
      icon: (
    ...
    },
    {
      ...
      description: "Condução completa dos processos de desembaraço.",
      icon: (
        <svg className="w-6 h-6 text-[#E5B584]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Gestão de embarques e coordenação da cadeia logística.",
      icon: (
        <svg className="w-6 h-6 text-[#E5B584]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Estruturação de operações financeiras e câmbio.",
      icon: (
        <svg className="w-6 h-6 text-[#E5B584]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description: "Intermediação de negócios e operações internacionais.",
      icon: (
        <svg className="w-6 h-6 text-[#E5B584]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex flex-col justify-start">
        ...
        <div ref={headerRef} className="max-w-3xl flex flex-col gap-4 sm:gap-5 text-left mb-14 lg:mb-20">
          ...
          <h2 className="font-poppins text-3xl sm:text-4xl lg:text-[45px] font-light leading-tight text-white">
            Soluções completas para o <br className="hidden sm:block" />
            <span className="font-semibold text-white/95">Comércio Exterior.</span>
          </h2>

          <p className="font-poppins font-light text-sm sm:text-base lg:text-lg text-white/70 leading-relaxed max-w-2xl">
            Reunimos consultoria estratégica, operação aduaneira, logística internacional e assessoria cambial para oferecer um atendimento integrado, seguro e eficiente em todas as etapas do comércio exterior.
          </p>
        </div>
